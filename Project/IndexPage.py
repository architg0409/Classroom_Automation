...
AutoButton=Button(window,text="Automatic",fg="white",font=f1,bg="green",command=display1)


ManLabel=Label(window,text="(It will put your system in Manual Mode)",font=f,fg="medium sea green",bg="lemon chiffon")
ManButton=Button(window,text="Manual",fg="white",font=f1,bg="green",command=display2)
...
AutoLabel.place(x=265,y=360)
ManButton.place(x=350,y=470)
ManLabel.place(x=280,y=550)
